...
import com.tekarch.webdriver.WebDrManagerFactory;
...
public class TestBase {
	...
	public void TriggerDependencies() throws Exception {
		...
		oCommUtil.loadPropertyFiles(System.getProperty("user.dir") + "/resources/TestData/config.properties");
		oCommUtil.loadLog4jProperty(System.getProperty("user.dir") + "/resources/TestData/log4j.properties");
	...
	*/	if(System.getProperty("Environment") == null || System.getProperty("Environment").isEmpty())
		...
		{
			driver = WebDrManagerFactory.createDriver(System.getProperty("Browser"));
